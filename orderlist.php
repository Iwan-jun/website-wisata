			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						...
						<p>Lakukan upload bukti pembayaran</p>
					</div>
				</div>
				...
				<table class="table table-bordered table-striped table-hover">
                	<thead>
                    	<tr class="info fg-white">
                            ...
                            <th class="text-left">Pilihan Hotel</th>
					...
					?>
                    	<tr>
                            ...
                            <td><?php
								...
								?>
								<a class="btn btn-success" href="orderfinish.php?id=<?php echo $isi_tbl[0]; ?>" data-hint="<?php echo $txtS ?>">Berhasil</a>
								<?php
