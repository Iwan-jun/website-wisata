			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Reservasi</h3>
						<p>Silahkan mengisi form reservasi terlebih dahulu</p>
					</div>
				</div>
				...
				<form action="proses.php?aksi=tambah_order" method="post" enctype="multipart/form-data">
					...
					<div class="row animate-box">
						<div class="col-md-6">
							<h3 class="section-title">Keterangan Reservasi</h3>
						<ul class="section-title">
<li>Jika terdapat perubahan data reservasi maupun pembatalan reservasi, 
	silahkan menghubungi kami melalui kontak yang disediakan. Perubahan 
	dan pembatalan hanya bisa dilakukan dalam waktu 5 hari setelah reservasi, 
	jika lebih dari 5 hari maka pengunjung tidak dapat mengubah data maupun 
	mendapat pengembalian baiaya. Untuk pengembalian biaya karena pembatalan 
	akan dikenakan potongan sebesar 20% dari total biaya yang telah dibayar.</li>
<li>Pastikan data yang anda isi benar adanya sebelum melakukan transaksi untuk 
	menghindari kesalahan dalam memasukkan data.</li>
...
<?php endforeach; ?>
								...
								<div class="col-md-6">
										<div class="input-field">
													<label for="date-start">Tanggal Keberangkatan</label>
