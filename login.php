						...
						<div class="row">
							...
							<div class="desc2 animate-box">
								<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
									...
									<h3>Nikmati perjalanan yang menyenangkan bersama kami</h3>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Registrasi</h3>
						<p>Silahkan melakukan registrasi jika belum memiliki akun</p>
					</div>
				</div>
				<form action="proses.php?aksi=tambah" method="post" enctype="multipart/form-data">
					<div class="row animate-box">
						<div class="col-md-6">
							...
							<p>Wonderful Malang merupakan platform online yang menyediakan layanan reservasi travel khusus untuk daerah Kota Malang. Kami menawarkan banyak destinasi wisata menarik yang tentunya akan menjadi pilihan terbaik bagi anda.</p>
							<ul class="contact-info">
								<li><i class="icon-location-pin"></i>Jalan Ketintang</li>
								<li><i class="icon-phone2"></i>+628815075943</li>
								<li><i class="icon-mail"></i><a href="#">wonderfulmalang@gmail.com</a></li>
								<li><i class="icon-instagram"></i><a href="#">WonderfulMalangD4</a></li>
							</ul>
						</div>
						<div class="col-md-6">
							<div class="row">
							...
							<input type="text" class="form-control" placeholder="No Rekening" name="no_rek">
								...
								<div class="col-md-6">
										<div class="input-field">
													<label for="date-start">Tanggal Lahir</label>
