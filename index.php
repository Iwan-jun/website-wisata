						...
						<div class="row">
							...
							<div class="desc2 animate-box">
								<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
									...
									<h3>Nikmati perjalanan wisata di Kota Malang</h3>
									<span class="price">Mulai dari Rp250.000</span>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Rekomendasi Tempat Wisata Malang</h3>
						<p>Temukan destinasi wisatamu bersama kami melalui beberapa rekomendasi tempat di Kota Malang</p>
					</div>
				</div>
